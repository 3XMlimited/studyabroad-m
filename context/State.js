...
const allQuestions = ['Do you want to study in a country where English is the primary language spoken ?', // location
...
`Did you know that some Universities in Europe and the USA offer the opportunity to Study for Free ?`] // budget
  ...
  return (
    <AppContext.Provider value={{ answers,answeredCount,budget,cult,language,academic,location,setAnswers,setAnsweredCount,getAnswer,totalQuestions,goBack }}>
      {props.children}
    </AppContext.Provider>
  )
}
